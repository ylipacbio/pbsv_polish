...
def get_parser():
    ...
    parser.add_argument("input_fq_fn", help="Input FASTA filename")
...
def run(args):
    ...
    substr_fasta(fileobj=fileobj, chrom=args.chrom, start=args.start, end=args.end, o_fasta_fn=args.output_fa_fn)
